...
def kb_root() -> str:
    ...
    the upstream tool's own XDG-style default — never a machine-specific path in
    tree. Unused here: this repo runs the guard in --shapes-only mode."""  # PII-OK
    return os.environ.get("LIFE_AGENT_KB") or os.path.expanduser("~/.life-agent/kb")  # PII-OK
